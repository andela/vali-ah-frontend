...
export function* makeGetCommentsAPICall({ payload }) {
  try {
...
export function* makeCreateCommentAPICall({ payload }) {
  try {
...
export function* watchGetCommentsRequest() {
  yield takeLatest(types.GET_COMMENTS_REQUEST, makeGetCommentsAPICall);
}

export function* watchCreateCommentRequest() {
  yield takeLatest(types.CREATE_COMMENT_REQUEST, makeCreateCommentAPICall);
}
