...
describe('Search', () => {
  ...
  it('should render the tag, title, author and keyword buttons', () => {
    ...
    expect(wrapper.find('.search-container__query-button-tag')).toHaveLength(1);
    expect(wrapper.find('.search-container__query-button-title')).toHaveLength(1);
    expect(wrapper.find('.search-container__query-button-author')).toHaveLength(1);
    expect(wrapper.find('.search-container__query-button-keyword')).toHaveLength(1);
  ...
  it('should update the state to filter articles based on their tag', () => {
    const button = wrapper.find('.search-container__query-button-tag');
    const input = wrapper.find('input');
  ...
  it('should update the state to filter articles based on their title', () => {
    const button = wrapper.find('.search-container__query-button-title');
    const input = wrapper.find('input');
  ...
  it('should update the state to filter articles based on their author', () => {
    const button = wrapper.find('.search-container__query-button-author');
    const input = wrapper.find('input');
  ...
  it('should update the state to filter articles based on keyword', () => {
    const button = wrapper.find('.search-container__query-button-keyword');
    const input = wrapper.find('input');
