...
export class Comments extends React.Component {
  ...
  render() {
    ...
    const { comment, saving } = this.state;
...
const mapStateToProps = ({ articleComments }) => ({
  ...
  loading: articleComments.apiCallsInProgress > 0,
  error: articleComments.error,
  createdComment: articleComments.createdComment
});

export default connect(mapStateToProps, { getCommentsRequest, createCommentRequest })(Comments);
